...
namespace cakirMagaza.UI
{
    public partial class FrmOdeme : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (nmTutar.Value == 0)
            {
                errorProvider1.SetError(nmTutar, "Yanlış giriş yaptınız, Lütfen tutar giriniz!");
                nmTutar.Focus();
                return;
            ...
            {
                errorProvider1.SetError(cbTur, "Lütfen ödeme türü seçin!");
                cbTur.Focus();
                return;
            }
            else
            ...
            if (txtAciklama.Text == "")
            {
                errorProvider1.SetError(txtAciklama, "Hatalı giriş yaptınız");
                txtAciklama.Focus();
                return;
            }
            else
